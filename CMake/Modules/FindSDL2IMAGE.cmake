...
# ::
#
# SDL2_IMAGE_LIBRARY (same value as SDL2_IMAGE_LIBRARIES)
# SDL2_IMAGE_INCLUDE_DIR (same value as SDL2_IMAGE_INCLUDE_DIRS)
# SDL2_IMAGE_FOUND (same value as SDL2_IMAGE_FOUND)
#
#
#
...
if(NOT SDL2_IMAGE_INCLUDE_DIR AND SDL2_IMAGE_INCLUDE_DIR)
  set(SDL2_IMAGE_INCLUDE_DIR ${SDL2_IMAGE_INCLUDE_DIR} CACHE PATH "directory cache entry initialized from old variable name")
endif()
...
if(NOT SDL2_IMAGE_LIBRARY AND SDL2_IMAGE_LIBRARY)
  set(SDL2_IMAGE_LIBRARY ${SDL2_IMAGE_LIBRARY} CACHE FILEPATH "file cache entry initialized from old variable name")
endif()
...
set(SDL2_IMAGE_FOUND ${SDL2_IMAGE_FOUND})
